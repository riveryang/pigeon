...
public class ServiceUnpublishServlet extends HttpServlet {
    ...
    private static final boolean autoUnpublish = ConfigManagerLoader.getConfigManager()
            .getBooleanValue("pigeon.autounpublish.enable", true);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (Utils.isGranted(request)) {
            boolean autoUnpublishEnable = ConfigManagerLoader.getConfigManager()
                    .getBooleanValue(Constants.KEY_AUTOUNPUBLISH_ENABLE, true);
