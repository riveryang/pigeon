...
public class LoadBalanceManager {
    ...
    private static String stepTicks = configManager.getStringValue("pigeon.loadbalance.stepticks",
            ...
            if (!loadBalanceMap.containsKey(loadBalance)) {
                try {
                    ...
                    throw new IllegalArgumentException(
                            "failed to register loadbalance[service=" + serviceId + ",class=" + loadBalance + "]", e);
                }
            } else {
